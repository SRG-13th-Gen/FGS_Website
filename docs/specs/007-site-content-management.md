...
- **Articles**: All Articles (`/admin/articles` — search, category filter, pagination, edit,
  trash), New Article (`/admin/articles/new`, the existing SPEC-003 publish flow) — see

...
- Check docs links, status consistency, traceability, and whitespace for documentation work. Preserve the existing DESIGN guidance and the empty CI_CD placeholder.
